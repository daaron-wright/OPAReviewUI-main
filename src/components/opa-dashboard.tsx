/**
 * OPA Server Dashboard - The Command Center
 * Because Master Jedi needs to see EVERYTHING after publishing!
 * Follows coding principles with proper separation of concerns
 */
'use client';
...
import { PolicyTable } from './dashboard/policy-table';
import { SystemMetricsPanel } from './dashboard/system-metrics-panel';
...
export function OPADashboard({ show, onClose }: OPADashboardProps): JSX.Element | null {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 animate-fade-in">
      {/* Header */}
