...
interface ReviewerProfilePillProps {
  readonly name: string;
  readonly email: string;
  readonly avatarUrl: string;
}

function ReviewerProfilePill({ name, email, avatarUrl }: ReviewerProfilePillProps): JSX.Element {
  return (
    <div className="inline-flex items-center gap-3 rounded-full border border-[#dbe9e3] bg-[#f6faf8] px-4 py-2 shadow-sm">
