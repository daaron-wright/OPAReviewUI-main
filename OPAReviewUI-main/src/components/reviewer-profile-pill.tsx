  ...
  return (
    <div ref={containerRef} className="relative inline-block text-left">
      ...
      >
        ...
        <span className="ml-2 inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#f3f8f6] text-[#0f766e] transition group-hover:bg-[#edf6f3]">
          <svg
      ...
      {isOpen && (
        <div className="absolute right-0 top-full z-50 mt-3 w-60 rounded-2xl border border-[#d8e4df] bg-white p-3 shadow-[0_28px_48px_-28px_rgba(15,118,110,0.55)]">
